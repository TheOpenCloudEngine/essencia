...
public class RemoteUtils {
    ...
    private static String ENCODE_SUFFIX = "_[%][$]";
    /**
    ...
    public static String format(Object obj) throws IOException {
        ...
        return RemoteFormatterUtils.prettyPrint(json);
    }
    ...
    public static Map decodeJson(String str) throws Exception {
        String decode = str.replaceAll(ENCODE_SUFFIX, "\"");
        return marshal(decode);
    }
