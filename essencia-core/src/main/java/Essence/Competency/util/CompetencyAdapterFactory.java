 ...
 * @generated
 */
public class CompetencyAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public CompetencyAdapterFactory() {
	 ...
	 * @generated
	 */
	protected CompetencySwitch<Adapter> modelSwitch =
		new CompetencySwitch<Adapter>() {
			@Override
			public Adapter caseCompetency(Competency object) {
				return createCompetencyAdapter();
			}
			@Override
			public Adapter caseCompetencyLevel(CompetencyLevel object) {
				return createCompetencyLevelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link Essence.Competency.Competency <em>Competency</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCompetencyAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link Essence.Competency.CompetencyLevel <em>Level</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCompetencyLevelAdapter() {
		return null;
	}
