 ...
 * <ul>
 *   <li>{@link Essence.DiagramInterchange.impl.DetailCardImpl#getHeader <em>Header</em>}</li>
 *   <li>{@link Essence.DiagramInterchange.impl.DetailCardImpl#getLeftHeaderSide <em>Left Header Side</em>}</li>
 *   <li>{@link Essence.DiagramInterchange.impl.DetailCardImpl#getFooter <em>Footer</em>}</li>
 *   <li>{@link Essence.DiagramInterchange.impl.DetailCardImpl#getBody <em>Body</em>}</li>
 *   <li>{@link Essence.DiagramInterchange.impl.DetailCardImpl#getModelElement <em>Model Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
