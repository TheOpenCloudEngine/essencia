...
public class ViewSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ViewPackage.VIEW_SELECTION: {
				ViewSelection viewSelection = (ViewSelection)theEObject;
				T result = caseViewSelection(viewSelection);
				if (result == null) result = caseLanguageElement(viewSelection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewPackage.FEATURE_SELECTION: {
				FeatureSelection featureSelection = (FeatureSelection)theEObject;
				T result = caseFeatureSelection(featureSelection);
				if (result == null) result = caseLanguageElement(featureSelection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseViewSelection(ViewSelection object) {
		return null;
	}
