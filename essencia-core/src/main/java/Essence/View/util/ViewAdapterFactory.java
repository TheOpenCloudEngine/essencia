...
public class ViewAdapterFactory extends AdapterFactoryImpl {
	...
	protected ViewSwitch<Adapter> modelSwitch =
		new ViewSwitch<Adapter>() {
			@Override
			public Adapter caseViewSelection(ViewSelection object) {
				return createViewSelectionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link Essence.View.ViewSelection <em>Selection</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createViewSelectionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link Essence.View.FeatureSelection <em>Feature Selection</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
