...
public class DateUtils {
     ...
     * @param parsePatterns 파싱하는데 사용하는 날짜 형식 패턴. <tt>null</tt>이 아님. {@link SimpleDateFormat}을 참고.
     * @return 파싱된 날짜
     * @throws IllegalArgumentException 문자열로 된 날짜 또는 패턴이 <tt>null</tt>인 경우
     * @throws ParseException 패턴이 적합하지 않은 경우
     */
     ...
     *
     * @param date          날짜(<tt>null</tt>이 아님)
     * @param calendarField {@link Calendar}의 필드
     * @param amount        추가할 양(음수도 가능)
     ...
     * @return 연산된 날짜
     * @throws ParseException 날짜를 지정한 패턴으로 파싱할 수 없는 경우
     */
    ...
    /**
     * "yyyyMMdd" 문자열 형식의 날짜를 {@link Calendar} 형식으로 변환한다.
     * <p>
     * <pre>
