 ...
 * <ul>
 *   <li>{@link EndeavorPropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link EndeavorPropertyImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link EndeavorPropertyImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link EndeavorPropertyImpl#getType <em>Type</em>}</li>
 *   <li>{@link EndeavorPropertyImpl#getOwningAssociation <em>Owning Association</em>}</li>
 *   <li>{@link EndeavorPropertyImpl#getAssociation <em>Association</em>}</li>
 *   <li>{@link EndeavorPropertyImpl#getLanguageElement <em>Language Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
