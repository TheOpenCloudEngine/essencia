 ...
 * <ul>
 *   <li>{@link LanguageElementImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link LanguageElementImpl#getTag <em>Tag</em>}</li>
 *   <li>{@link LanguageElementImpl#isIsSuppressable <em>Is Suppressable</em>}</li>
 *   <li>{@link LanguageElementImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link LanguageElementImpl#getOwner <em>Owner</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
