...
public class FoundationPackageImpl extends EPackageImpl implements FoundationPackage {
	...
	public static FoundationPackage init() {
		if (isInited) return (FoundationPackage) Registry.INSTANCE.getEPackage(FoundationPackage.eNS_URI);

		// Obtain or create and register package
		FoundationPackageImpl theFoundationPackage = (FoundationPackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof FoundationPackageImpl ? Registry.INSTANCE.get(eNS_URI) : new FoundationPackageImpl());
		...
		Registry.INSTANCE.put(FoundationPackage.eNS_URI, theFoundationPackage);
	...
	public void initializePackageContents() {
		...
		EssencePackage theEssencePackage = (EssencePackage) Registry.INSTANCE.getEPackage(EssencePackage.eNS_URI);
