 ...
 * <ul>
 *   <li>{@link ElementGroupImpl#getName <em>Name</em>}</li>
 *   <li>{@link ElementGroupImpl#getIcon <em>Icon</em>}</li>
 *   <li>{@link ElementGroupImpl#getBriefDescription <em>Brief Description</em>}</li>
 *   <li>{@link ElementGroupImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ElementGroupImpl#getReferredElements <em>Referred Elements</em>}</li>
 *   <li>{@link ElementGroupImpl#getMergeResolution <em>Merge Resolution</em>}</li>
 *   <li>{@link ElementGroupImpl#getExtension <em>Extension</em>}</li>
 *   <li>{@link ElementGroupImpl#getOwnedElements <em>Owned Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
