 ...
 * <ul>
 *   <li>{@link ActivityImpl#getRequiredCompetencyLevel <em>Required Competency Level</em>}</li>
 *   <li>{@link ActivityImpl#getAction <em>Action</em>}</li>
 *   <li>{@link ActivityImpl#getApproach <em>Approach</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
