 ...
 * <ul>
 *   <li>{@link Activity#getRequiredCompetencyLevel <em>Required Competency Level</em>}</li>
 *   <li>{@link Activity#getAction <em>Action</em>}</li>
 *   <li>{@link Activity#getApproach <em>Approach</em>}</li>
 * </ul>
 * </p>
 *
