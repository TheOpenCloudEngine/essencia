 ...
 * <!-- end-user-doc -->
 * @see DiagramInterchangePackage
 * @generated
 */
public class DiagramInterchangeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DiagramInterchangePackage.NODE: {
			...
			case DiagramInterchangePackage.LABEL: {
				Label label = (Label)theEObject;
				T result = caseLabel(label);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DiagramInterchangePackage.CARD: {
				Card card = (Card)theEObject;
				T result = caseCard(card);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DiagramInterchangePackage.LINK: {
			...
			case DiagramInterchangePackage.DETAIL_CARD: {
				DetailCard detailCard = (DetailCard)theEObject;
				T result = caseDetailCard(detailCard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DiagramInterchangePackage.TEXT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Detail Card</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Detail Card</em>'.
	 * @see #doSwitch(EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDetailCard(DetailCard object) {
		return null;
	}
