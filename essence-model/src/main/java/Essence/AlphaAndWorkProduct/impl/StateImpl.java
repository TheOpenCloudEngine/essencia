 ...
 * <ul>
 *   <li>{@link StateImpl#getName <em>Name</em>}</li>
 *   <li>{@link StateImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link StateImpl#getAlpha <em>Alpha</em>}</li>
 *   <li>{@link StateImpl#getSuccessor <em>Successor</em>}</li>
 *   <li>{@link StateImpl#getCheckListItem <em>Check List Item</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
