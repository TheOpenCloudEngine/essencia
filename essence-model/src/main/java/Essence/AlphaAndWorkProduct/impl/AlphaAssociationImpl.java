 ...
 * <ul>
 *   <li>{@link AlphaAssociationImpl#getName <em>Name</em>}</li>
 *   <li>{@link AlphaAssociationImpl#getEnd1lowerBound <em>End1lower Bound</em>}</li>
 *   <li>{@link AlphaAssociationImpl#getEnd1upperBound <em>End1upper Bound</em>}</li>
 *   <li>{@link AlphaAssociationImpl#getEnd2lowerBound <em>End2lower Bound</em>}</li>
 *   <li>{@link AlphaAssociationImpl#getEnd2upperBound <em>End2upper Bound</em>}</li>
 *   <li>{@link AlphaAssociationImpl#getEnd1 <em>End1</em>}</li>
 *   <li>{@link AlphaAssociationImpl#getEnd2 <em>End2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
