...
public class AlphaAndWorkProductPackageImpl extends EPackageImpl implements AlphaAndWorkProductPackage {
	...
	public static AlphaAndWorkProductPackage init() {
		if (isInited) return (AlphaAndWorkProductPackage) Registry.INSTANCE.getEPackage(AlphaAndWorkProductPackage.eNS_URI);

		// Obtain or create and register package
		AlphaAndWorkProductPackageImpl theAlphaAndWorkProductPackage = (AlphaAndWorkProductPackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof AlphaAndWorkProductPackageImpl ? Registry.INSTANCE.get(eNS_URI) : new AlphaAndWorkProductPackageImpl());
		...
		Registry.INSTANCE.put(AlphaAndWorkProductPackage.eNS_URI, theAlphaAndWorkProductPackage);
