...
public class UserDefinedTypesPackageImpl extends EPackageImpl implements UserDefinedTypesPackage {
	 ...
	 * <!-- end-user-doc -->
	 * @see Registry
	 * @see UserDefinedTypesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static UserDefinedTypesPackage init() {
		if (isInited) return (UserDefinedTypesPackage) Registry.INSTANCE.getEPackage(UserDefinedTypesPackage.eNS_URI);

		// Obtain or create and register package
		UserDefinedTypesPackageImpl theUserDefinedTypesPackage = (UserDefinedTypesPackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof UserDefinedTypesPackageImpl ? Registry.INSTANCE.get(eNS_URI) : new UserDefinedTypesPackageImpl());
		...
		Registry.INSTANCE.put(UserDefinedTypesPackage.eNS_URI, theUserDefinedTypesPackage);
