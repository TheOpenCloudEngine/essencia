...
import org.uengine.kernel.graph.DataAssociationTransition;
import org.uengine.kernel.graph.Transition;
import org.uengine.modeling.IRelation;
import org.uengine.modeling.RelationPropertiesView;
import org.uengine.modeling.Symbol;

public class DataAssociationTransitionView extends TransitionView{
	
	public final static String SHAPE_ID = "OG.shape.bpmn.C_DataAssociation";
	
	public DataAssociationTransitionView(){
		
	}
	
	public DataAssociationTransitionView(IRelation relation){
		super(relation);
	}
	...
	private static Symbol fillSymbol (Symbol symbol){
		...
		symbol.setWidth(200);
		symbol.setElementClassName(DataAssociationTransition.class.getName());
