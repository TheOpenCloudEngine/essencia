 ...
 * <ul>
 *   <li>{@link Essence.DiagramInterchange.impl.CardImpl#getLeftHeaderSide <em>Left Header Side</em>}</li>
 *   <li>{@link Essence.DiagramInterchange.impl.CardImpl#getLeftBodySide <em>Left Body Side</em>}</li>
 *   <li>{@link Essence.DiagramInterchange.impl.CardImpl#getRightBodySide <em>Right Body Side</em>}</li>
 *   <li>{@link Essence.DiagramInterchange.impl.CardImpl#getRightHeaderSide <em>Right Header Side</em>}</li>
 *   <li>{@link Essence.DiagramInterchange.impl.CardImpl#getModelElement <em>Model Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
