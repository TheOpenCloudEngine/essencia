...
public class EssenceFactoryImpl extends EFactoryImpl implements EssenceFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case EssencePackage.URI:
				return createURIFromString(eDataType, initialValue);
			case EssencePackage.QNAME:
				return createQNameFromString(eDataType, initialValue);
			case EssencePackage.GRAPHICAL_ELEMENT:
				return createGraphicalElementFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case EssencePackage.GRAPHICAL_ELEMENT:
				return convertGraphicalElementToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public Object createGraphicalElementFromString(EDataType eDataType, String initialValue) {
		return super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertGraphicalElementToString(EDataType eDataType, Object instanceValue) {
		return super.convertToString(eDataType, instanceValue);
	}
