...
public class EssencePackageImpl extends EPackageImpl implements EssencePackage {
	 ...
	 * @see Essence.EssencePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static EssencePackage init() {
		if (isInited) return (EssencePackage)EPackage.Registry.INSTANCE.getEPackage(EssencePackage.eNS_URI);

		// Obtain or create and register package
		EssencePackageImpl theEssencePackage = (EssencePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EssencePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new EssencePackageImpl());
		...
		EPackage.Registry.INSTANCE.put(EssencePackage.eNS_URI, theEssencePackage);
	...
	public void initializePackageContents() {
		...
		UserDefinedTypesPackage theUserDefinedTypesPackage = (UserDefinedTypesPackage)EPackage.Registry.INSTANCE.getEPackage(UserDefinedTypesPackage.eNS_URI);
		ActivitySpaceAndActivityPackage theActivitySpaceAndActivityPackage = (ActivitySpaceAndActivityPackage)EPackage.Registry.INSTANCE.getEPackage(ActivitySpaceAndActivityPackage.eNS_URI);
		...
		CompetencyPackage theCompetencyPackage = (CompetencyPackage)EPackage.Registry.INSTANCE.getEPackage(CompetencyPackage.eNS_URI);
		AlphaAndWorkProductPackage theAlphaAndWorkProductPackage = (AlphaAndWorkProductPackage)EPackage.Registry.INSTANCE.getEPackage(AlphaAndWorkProductPackage.eNS_URI);
