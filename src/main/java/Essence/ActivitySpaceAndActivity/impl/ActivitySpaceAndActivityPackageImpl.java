...
public class ActivitySpaceAndActivityPackageImpl extends EPackageImpl implements ActivitySpaceAndActivityPackage {
	...
	public static ActivitySpaceAndActivityPackage init() {
		if (isInited) return (ActivitySpaceAndActivityPackage)EPackage.Registry.INSTANCE.getEPackage(ActivitySpaceAndActivityPackage.eNS_URI);

		// Obtain or create and register package
		ActivitySpaceAndActivityPackageImpl theActivitySpaceAndActivityPackage = (ActivitySpaceAndActivityPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ActivitySpaceAndActivityPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ActivitySpaceAndActivityPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(ActivitySpaceAndActivityPackage.eNS_URI, theActivitySpaceAndActivityPackage);
