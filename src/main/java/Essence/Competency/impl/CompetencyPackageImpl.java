...
public class CompetencyPackageImpl extends EPackageImpl implements CompetencyPackage {
	 ...
	 * @see Essence.Competency.CompetencyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static CompetencyPackage init() {
		if (isInited) return (CompetencyPackage)EPackage.Registry.INSTANCE.getEPackage(CompetencyPackage.eNS_URI);

		// Obtain or create and register package
		CompetencyPackageImpl theCompetencyPackage = (CompetencyPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof CompetencyPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new CompetencyPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(CompetencyPackage.eNS_URI, theCompetencyPackage);
